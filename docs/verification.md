...
**未在真机验证**：报告问题的 HONOR 200 Pro 当时未连接（`adb devices` 只有模拟器），真机仍装着带此 bug 的包，需重新安装 `Personal.Schedule-v1.2.0.apk`（SHA256 `94B37D6B601245F6F048CCF01CFC19B1B936B2A28A0FE1C1F6983150E8AD9D8E`，先前那份已作废）。
